...
@pytest.mark.parametrize(
    "directories", ["/etc/mysql_exporter", "/usr/local/opt/mysql_exporter"]
)
...
@pytest.mark.parametrize("files", ["/etc/mysql_exporter/mysql_exporter"])
...
def test_files(host, get_vars):
    ...
    version = local_facts(host=host, fact="mysql_exporter").get("version")
